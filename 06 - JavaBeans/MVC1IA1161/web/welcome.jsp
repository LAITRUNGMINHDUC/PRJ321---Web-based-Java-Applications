...
<html>
    ...
    <body>
        ...
        --%>
        <myTag:datagrid dataSource="JAVALAB"
                        sqlStatement="SELECT * FROM Registration WHERE Lastname LIKE ?"
                        lastname="%1%"/>

        <myTag:datagrid dataSource="JAVALAB"
                        sqlStatement="SELECT * FROM Registration WHERE Username = ? AND Password = ?"
                        a = "123" b="123"/>
