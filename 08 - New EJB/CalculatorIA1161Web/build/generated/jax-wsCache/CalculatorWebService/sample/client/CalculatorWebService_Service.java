 ...
 * 
 */
@WebServiceClient(name = "CalculatorWebService", targetNamespace = "http://jws.sample/", wsdlLocation = "http://localhost:8080/CalculatorIA1161/CalculatorWebService/CalculatorWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWEBSERVICE_QNAME = new QName("http://jws.sample/", "CalculatorWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/CalculatorIA1161/CalculatorWebService/CalculatorWebService?wsdl");
    ...
    public CalculatorWebService getCalculatorWebServicePort() {
        return super.getPort(new QName("http://jws.sample/", "CalculatorWebServicePort"), CalculatorWebService.class);
    }
    ...
    public CalculatorWebService getCalculatorWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jws.sample/", "CalculatorWebServicePort"), CalculatorWebService.class, features);
    }
